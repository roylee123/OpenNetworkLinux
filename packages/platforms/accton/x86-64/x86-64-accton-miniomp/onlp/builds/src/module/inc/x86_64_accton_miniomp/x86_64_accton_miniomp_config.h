 ...
 *
 * @file
 * @brief x86_64_accton_miniomp Configuration Header
 *
 * @addtogroup x86_64_accton_miniomp-config
 * @{
 *
 *****************************************************************************/
...
#include <x86_64_accton_miniomp_custom_config.h>
#endif
...
typedef struct x86_64_accton_miniomp_config_settings_s {
    /** name */
    const char* name;
    /** value */
    const char* value;
} x86_64_accton_miniomp_config_settings_t;

/** Configuration settings table. */
/** x86_64_accton_miniomp_config_settings table. */
extern x86_64_accton_miniomp_config_settings_t x86_64_accton_miniomp_config_settings[];

/**
 * @brief Lookup a configuration setting.
 * @param setting The name of the configuration option to lookup.
 */
const char* x86_64_accton_miniomp_config_lookup(const char* setting);

/**
 * @brief Show the compile-time configuration.
 * @param pvs The output stream.
 */
int x86_64_accton_miniomp_config_show(struct aim_pvs_s* pvs);

/* <auto.end.cdefs(X86_64_ACCTON_MINIPACK_CONFIG_HEADER).header> */

#include "x86_64_accton_miniomp_porting.h"
