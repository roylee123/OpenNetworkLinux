...
static int
as5816_54x_sfp_node_read_int(char *node_path, int *value, int data_len)
{
    int ret = 0;
    char buf[8] = {0};
    *value = 0;
...
static char*
as5816_54x_sfp_get_port_path_addr(int port, int addr, char *node_name)
{
...
static char*
as5816_54x_sfp_get_port_path(int port, char *node_name)
{
    return as5816_54x_sfp_get_port_path_addr(port, 50, node_name);
}
...
{
    /*
     * The QSFP port numbering on the powerpc-as5816-54x-r0b platform
     * differs from the numbering on the production
     * powerpc-accton-as5816-54x-r0 platform.
     *
...
/**
 * The CPLD registers on the as5816 use the original R0B QSFP (horizontal)
 * portmapping.
 *
...
onlp_sfpi_is_present(int port)
{
     ...
     */
    int present;
    char* path = as5816_54x_sfp_get_port_path(port, "sfp_is_present");

    if (as5816_54x_sfp_node_read_int(path, &present, 1) != 0) {
...
onlp_sfpi_presence_bitmap_get(onlp_sfp_bitmap_t* dst)
{
    ...
    path = as5816_54x_sfp_get_port_path(0, "sfp_is_present_all");
    fp = fopen(path, "r");
...
onlp_sfpi_rx_los_bitmap_get(onlp_sfp_bitmap_t* dst)
{
    ...
    path = as5816_54x_sfp_get_port_path(0, "sfp_rx_los_all");
    fp = fopen(path, "r");
...
{
    char* path = as5816_54x_sfp_get_port_path(port, "sfp_eeprom");
...
{
    char* path = as5816_54x_sfp_get_port_path_addr(port, 51, "sfp_eeprom");
    memset(data, 0, 256);
...
onlp_sfpi_control_set(int port, onlp_sfp_control_t control, int value)
{
    ...
    switch(control)
        ...
        case ONLP_SFP_CONTROL_TX_DISABLE:
            {
                char* path = as5816_54x_sfp_get_port_path(port, "sfp_tx_disable");
...
onlp_sfpi_control_get(int port, onlp_sfp_control_t control, int* value)
{
    ...
    switch(control)
        ...
        case ONLP_SFP_CONTROL_RX_LOS:
            {
                path = as5816_54x_sfp_get_port_path(port, "sfp_rx_loss");

                if (as5816_54x_sfp_node_read_int(path, value, 1) != 0) {
        ...
        case ONLP_SFP_CONTROL_TX_FAULT:
            {
                path = as5816_54x_sfp_get_port_path(port, "sfp_tx_fault");
        ...
        case ONLP_SFP_CONTROL_TX_DISABLE:
            {
                path = as5816_54x_sfp_get_port_path(port, "sfp_tx_disable");

                if (as5816_54x_sfp_node_read_int(path, value, 0) != 0) {
