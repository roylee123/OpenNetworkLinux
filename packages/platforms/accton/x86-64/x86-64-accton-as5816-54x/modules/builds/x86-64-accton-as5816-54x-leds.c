/*
 * A LED driver for the accton_as5816_54x_led
 *
...
#define DRVNAME "as5816_54x_led"

struct accton_as5816_54x_led_data {
...
static struct accton_as5816_54x_led_data  *ledctl = NULL;
...
static int accton_as5816_54x_led_read_value(u8 reg)
{
    return as5816_54x_i2c_cpld_read(0x60, reg);
}

static int accton_as5816_54x_led_write_value(u8 reg, u8 value)
{
    return as5816_54x_i2c_cpld_write(0x60, reg, value);
}

static void accton_as5816_54x_led_update(void)
{
    ...
    if (time_after(jiffies, ledctl->last_updated + HZ + HZ / 2)
        ...
        dev_dbg(&ledctl->pdev->dev, "Starting accton_as5816_54x_led update\n");

        /* Update LED data
         */
        for (i = 0; i < ARRAY_SIZE(ledctl->reg_val); i++) {
            int status = accton_as5816_54x_led_read_value(led_reg[i]);
...
static void accton_as5816_54x_led_set(struct led_classdev *led_cdev,
                                      ...
                                      u8 reg, enum led_type type)
{
    ...
    reg_val = accton_as5816_54x_led_read_value(reg);
    ...
    accton_as5816_54x_led_write_value(reg, reg_val);
...
static void accton_as5816_54x_led_psu_1_set(struct led_classdev *led_cdev,
                                            enum led_brightness led_light_mode)
{
    accton_as5816_54x_led_set(led_cdev, led_light_mode, led_reg[1], LED_TYPE_PSU1);
}

static enum led_brightness accton_as5816_54x_led_psu_1_get(struct led_classdev *cdev)
{
    accton_as5816_54x_led_update();
    return led_reg_val_to_light_mode(LED_TYPE_PSU1, ledctl->reg_val[1]);
}

static void accton_as5816_54x_led_psu_2_set(struct led_classdev *led_cdev,
                                            enum led_brightness led_light_mode)
{
    accton_as5816_54x_led_set(led_cdev, led_light_mode, led_reg[1], LED_TYPE_PSU2);
}

static enum led_brightness accton_as5816_54x_led_psu_2_get(struct led_classdev *cdev)
{
    accton_as5816_54x_led_update();
    return led_reg_val_to_light_mode(LED_TYPE_PSU2, ledctl->reg_val[1]);
}

static void accton_as5816_54x_led_fan_set(struct led_classdev *led_cdev,
                                          enum led_brightness led_light_mode)
{
    accton_as5816_54x_led_set(led_cdev, led_light_mode, led_reg[0], LED_TYPE_FAN);
}

static enum led_brightness accton_as5816_54x_led_fan_get(struct led_classdev *cdev)
{
    accton_as5816_54x_led_update();
...
static void accton_as5816_54x_led_fanx_set(struct led_classdev *led_cdev,
                                          enum led_brightness led_light_mode)
{
    ...
    for(i=0;i<ncount;i++)
    {
        ...
        if (led_cdev->name[nsize-1] == fanx_info[i].cname)
        {
            ...
            accton_as5816_54x_led_set(led_cdev, led_light_mode, led_reg[reg_id], led_type1);
            return;
        }
    }
}
...
static enum led_brightness accton_as5816_54x_led_fanx_get(struct led_classdev *cdev)
{
    enum led_type led_type1;
    int reg_id;
    int i, nsize;
...
static void accton_as5816_54x_led_diag_set(struct led_classdev *led_cdev,
                                           enum led_brightness led_light_mode)
{
    accton_as5816_54x_led_set(led_cdev, led_light_mode, led_reg[0], LED_TYPE_DIAG);
}

static enum led_brightness accton_as5816_54x_led_diag_get(struct led_classdev *cdev)
{
    accton_as5816_54x_led_update();
    return led_reg_val_to_light_mode(LED_TYPE_DIAG, ledctl->reg_val[0]);
}

static void accton_as5816_54x_led_loc_set(struct led_classdev *led_cdev,
                                          enum led_brightness led_light_mode)
{
    accton_as5816_54x_led_set(led_cdev, led_light_mode, led_reg[0], LED_TYPE_LOC);
}

static enum led_brightness accton_as5816_54x_led_loc_get(struct led_classdev *cdev)
{
    accton_as5816_54x_led_update();
    return led_reg_val_to_light_mode(LED_TYPE_LOC, ledctl->reg_val[0]);
}

static struct led_classdev accton_as5816_54x_leds[] = {
    [LED_TYPE_PSU1] = {
        .name             = "accton_as5816_54x_led::psu1",
        .default_trigger = "unused",
        .brightness_set     = accton_as5816_54x_led_psu_1_set,
        .brightness_get  = accton_as5816_54x_led_psu_1_get,
        .flags             = LED_CORE_SUSPENDRESUME,
        .max_brightness  = LED_MODE_AUTO,
    },
    [LED_TYPE_PSU2] = {
        .name             = "accton_as5816_54x_led::psu2",
        .default_trigger = "unused",
        .brightness_set     = accton_as5816_54x_led_psu_2_set,
        .brightness_get  = accton_as5816_54x_led_psu_2_get,
        .flags             = LED_CORE_SUSPENDRESUME,
        .max_brightness  = LED_MODE_AUTO,
    },
    [LED_TYPE_FAN] = {
        .name             = "accton_as5816_54x_led::fan",
        .default_trigger = "unused",
        .brightness_set     = accton_as5816_54x_led_fan_set,
        .brightness_get  = accton_as5816_54x_led_fan_get,
        .flags             = LED_CORE_SUSPENDRESUME,
        .max_brightness  = LED_MODE_AUTO,
    },
    [LED_TYPE_FAN1] = {
        .name             = "accton_as5816_54x_led::fan1",
        .default_trigger = "unused",
        .brightness_set     = accton_as5816_54x_led_fanx_set,
        .brightness_get  = accton_as5816_54x_led_fanx_get,
        .flags             = LED_CORE_SUSPENDRESUME,
        .max_brightness  = LED_MODE_AUTO,
    },
    [LED_TYPE_FAN2] = {
        .name             = "accton_as5816_54x_led::fan2",
        .default_trigger = "unused",
        .brightness_set     = accton_as5816_54x_led_fanx_set,
        .brightness_get  = accton_as5816_54x_led_fanx_get,
        .flags             = LED_CORE_SUSPENDRESUME,
    ...
    [LED_TYPE_FAN3] = {
        .name             = "accton_as5816_54x_led::fan3",
        .default_trigger = "unused",
        .brightness_set     = accton_as5816_54x_led_fanx_set,
        .brightness_get  = accton_as5816_54x_led_fanx_get,
        .flags             = LED_CORE_SUSPENDRESUME,
    ...
    [LED_TYPE_FAN4] = {
        .name             = "accton_as5816_54x_led::fan4",
        .default_trigger = "unused",
        .brightness_set     = accton_as5816_54x_led_fanx_set,
        .brightness_get  = accton_as5816_54x_led_fanx_get,
        .flags             = LED_CORE_SUSPENDRESUME,
    ...
    [LED_TYPE_FAN5] = {
        .name             = "accton_as5816_54x_led::fan5",
        .default_trigger = "unused",
        .brightness_set     = accton_as5816_54x_led_fanx_set,
        .brightness_get  = accton_as5816_54x_led_fanx_get,
        .flags             = LED_CORE_SUSPENDRESUME,
    ...
    [LED_TYPE_DIAG] = {
        .name             = "accton_as5816_54x_led::diag",
        .default_trigger = "unused",
        .brightness_set     = accton_as5816_54x_led_diag_set,
        .brightness_get  = accton_as5816_54x_led_diag_get,
        .flags             = LED_CORE_SUSPENDRESUME,
        .max_brightness  = LED_MODE_AUTO,
    },
    [LED_TYPE_LOC] = {
        .name             = "accton_as5816_54x_led::loc",
        .default_trigger = "unused",
        .brightness_set     = accton_as5816_54x_led_loc_set,
        .brightness_get  = accton_as5816_54x_led_loc_get,
        .flags             = LED_CORE_SUSPENDRESUME,
        .max_brightness  = LED_MODE_AUTO,
    },
};

static int accton_as5816_54x_led_suspend(struct platform_device *dev,
        pm_message_t state)
{
    int i = 0;

    for (i = 0; i < ARRAY_SIZE(accton_as5816_54x_leds); i++) {
        led_classdev_suspend(&accton_as5816_54x_leds[i]);
    }

    return 0;
}

static int accton_as5816_54x_led_resume(struct platform_device *dev)
{
    int i = 0;

    for (i = 0; i < ARRAY_SIZE(accton_as5816_54x_leds); i++) {
        led_classdev_resume(&accton_as5816_54x_leds[i]);
    }

    return 0;
}

static int accton_as5816_54x_led_probe(struct platform_device *pdev)
{
    int ret, i;

    for (i = 0; i < ARRAY_SIZE(accton_as5816_54x_leds); i++) {
        ret = led_classdev_register(&pdev->dev, &accton_as5816_54x_leds[i]);
    ...
    if (i != ARRAY_SIZE(accton_as5816_54x_leds)){
        int j;

        /* only unregister the LEDs that were successfully registered */
        for (j = 0; j < i; j++) {
            led_classdev_unregister(&accton_as5816_54x_leds[i]);
        }
    }
...
static int accton_as5816_54x_led_remove(struct platform_device *pdev)
{
    int i;
...
static struct platform_driver accton_as5816_54x_led_driver = {
    .probe      = accton_as5816_54x_led_probe,
    .remove     = accton_as5816_54x_led_remove,
    .suspend    = accton_as5816_54x_led_suspend,
    .resume     = accton_as5816_54x_led_resume,
    .driver     = {
    .name   = DRVNAME,
    .owner  = THIS_MODULE,
    },
...
static int __init accton_as5816_54x_led_init(void)
{
    int ret;
    ...
    ret = platform_driver_register(&accton_as5816_54x_led_driver);
    if (ret < 0) {
        goto exit;
    }

    ledctl = kzalloc(sizeof(struct accton_as5816_54x_led_data), GFP_KERNEL);
    if (!ledctl) {
        ret = -ENOMEM;
        platform_driver_unregister(&accton_as5816_54x_led_driver);
        goto exit;
    }
...
static void __exit accton_as5816_54x_led_exit(void)
{
...
module_init(accton_as5816_54x_led_init);
module_exit(accton_as5816_54x_led_exit);

MODULE_AUTHOR("Brandon Chuang <brandon_chuang@accton.com.tw>");
MODULE_DESCRIPTION("accton_as5816_54x_led driver");
MODULE_LICENSE("GPL");
