/*
 * An I2C multiplexer dirver for accton as5816 CPLD
 *
 ...
 * This includes the:
 *	 Accton as5816_54x CPLD1/CPLD2/CPLD3
 *
 * Based on:
...
static struct dmi_system_id as5816_54x_dmi_table[] = {
    {
        .ident = "Accton AS5816-54X",
        .matches = {
            DMI_MATCH(DMI_BOARD_VENDOR, "Accton"),
            DMI_MATCH(DMI_PRODUCT_NAME, "AS5816-54X"),
        },
    },
    {
        .ident = "Accton AS5816-54X",
...
int platform_accton_as5816_54x(void)
{
    return dmi_check_system(as5816_54x_dmi_table);
}
EXPORT_SYMBOL(platform_accton_as5816_54x);
...
static const struct i2c_device_id accton_i2c_cpld_mux_id[] = {
    { "as5816_54x_cpld1", as5816_54x_cpld1 },
    { "as5816_54x_cpld2", as5816_54x_cpld2 },
    { "as5816_54x_cpld3", as5816_54x_cpld3 },
    { }
};
			 ...
			 const struct i2c_device_id *id)
{
    ...
    if (data->type == as5816_54x_cpld2 || data->type == as5816_54x_cpld3) {
...
int as5816_54x_i2c_cpld_read(unsigned short cpld_addr, u8 reg)
{
    struct list_head   *list_node = NULL;
    struct cpld_client_node *cpld_node = NULL;
    int ret = -EPERM;
...
EXPORT_SYMBOL(as5816_54x_i2c_cpld_read);

int as5816_54x_i2c_cpld_write(unsigned short cpld_addr, u8 reg, u8 value)
{
    struct list_head   *list_node = NULL;
    struct cpld_client_node *cpld_node = NULL;
    int ret = -EIO;
...
EXPORT_SYMBOL(as5816_54x_i2c_cpld_write);

static struct i2c_driver accton_i2c_cpld_mux_driver = {
	.driver		= {
		.name	= "as5816_54x_cpld",
		.owner	= THIS_MODULE,
	},
